...
def main():
    ...
    PORT = int(os.getenv("PORT", 8443))  # Sử dụng 8443 làm mặc định, có thể ghi đè bằng biến môi trường
    ...
    telegram_app.add_error_handler(error_handler) #Add Error Handler
